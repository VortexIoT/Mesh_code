...
static void init_socket(SocketAddress *addr);
...
void start_mesh_led_control_example(NetworkInterface * interface,SocketAddress *addr){
...
static void receive() {
    ...
    while (something_in_socket) {
     ...
     //   printf("check byte", socket_getpeername(my_socket, source_addr));
...
static void init_socket(SocketAddress *addr)
{
 ...
 //   network_if->gethostbyname("fdd5:485b:545d:0:1b44:2870:478b:c846",addr);
